...
/**
  The ApiClient hides the implementation details of TVHJsonClient (NSURLSession-based).
  Stores request whatever they need and all network code is abstracted from them.
 */
